...
/*6600      */ UNSIGNED8      terminalInput[8];
...
/*6600, Data Type: UNSIGNED8, Array[8] */
      #define OD_terminalInput                           CO_OD_RAM.terminalInput
      #define ODL_terminalInput_arrayLength              8
